...
src/app/
  ...
  onecx-parameter-remote.module.ts  # Module Federation shell bootstrap
  shared/
  ...
  *parameter*/                   # Root directory for business components (feature)
    ...
    parameter-detail/        # Dialog — view, create, copy, or edit a parameter
    parameter-delete/        # Dialog — confirm parameter deletion
    usage-search/            # Search parameters by usage
    usage-detail/            # Display parameter usage details
src/assets/                  # Assets
...
- Component selectors: `app-` prefix, kebab-case element (`app-parameter-search`)
...
// data
private readonly dataSubject$ = new BehaviorSubject<Parameter[]>([])
public data$: Observable<Parameter[]> = this.dataSubject$.asObservable()
// dialog
